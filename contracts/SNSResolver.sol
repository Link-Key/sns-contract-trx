...
contract SNSResolver is Resolver, Initializable{
    ...
    function setRecords(string memory name_, address owner_) public onlySNS(msg.sender) override {
        records[name_].owner = owner_;
        emit OwnerChanged(name_, owner_);
    }

    function getEthAddress(string memory name_) external view override returns (string memory) {
        return records[name_].ethAddress;
    }

    function getBtcAddress(string memory name_) external view override returns (string memory){
        return records[name_].btcAddress;
    }

    function getLtcAddress(string memory name_) external view override returns (string memory){
        return records[name_].ltcAddress;
    }

    function getDogeAddress(string memory name_) external view override returns (string memory){
        return records[name_].dogeAddress;
    }

    function getIpfsUrl(string memory name_) external view override returns (string memory){
        return records[name_].ipfsUrl;
    }

    function getUrl(string memory name_) external view override returns (string memory){
        return records[name_].url;
    }

    function getEmail(string memory name_) external view override returns (string memory){
        return records[name_].email;
    }

    function getAvatar(string memory name_) external view override returns (string memory){
        return records[name_].avatar;
    }

    function getDescription(string memory name_) external view override returns (string memory){
        return records[name_].description;
    }

    function getNotice(string memory name_) external view override returns (string memory){
        return records[name_].notice;
    }

    function getKeywords(string memory name_) external view override returns (string memory){
        return records[name_].keywords;
    }

    function getComGithub(string memory name_) external view override returns (string memory){
        return records[name_].comGithub;
    }

    function getComReddit(string memory name_) external view override returns (string memory){
        return records[name_].comReddit;
    }

    function getComTwitter(string memory name_) external view override returns (string memory){
        return records[name_].comTwitter;
    }

    function getOrgTelegram(string memory name_) external view override returns (string memory){
        return records[name_].orgTelegram;
    }

    function setAllProperties(string memory name_, string memory recordsStr_) external override authorised(name_) {
    ...
    function getAllProperties(string memory name_) external view override returns (string memory){
